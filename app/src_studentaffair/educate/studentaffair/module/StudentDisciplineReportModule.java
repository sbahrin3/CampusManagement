...
public class StudentDisciplineReportModule extends LebahModule {
	
	protected String path = "studentaffair/student_discipline_report";
	...
	public String getReport() throws Exception { 
		...
		String sql = "select s from StudentDiscipline s where s.reportedDate between :date1 and :date2";

		List<StudentDiscipline> records = db.list(sql, h);
