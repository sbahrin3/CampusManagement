...
public class IText {
    ...
    public static final String RESULT
        = "c:/myprogram/PDF/font_factory.pdf";
...
//        document.add(Chunk.NEWLINE);
    ...
    public void myTest(String filename) throws IOException, DocumentException {
        // step 1
        Document document = new Document();
        // step 2
        PdfWriter.getInstance(document, new FileOutputStream(filename));
        ...
        Font f = FontFactory.getFont("Vivaldi Italic", BaseFont.WINANSI, BaseFont.EMBEDDED);
        document.add(new Paragraph("Vivaldi", f));
        document.add(Chunk.NEWLINE);
