...
public class StudentKohaAccountModule extends AjaxModule {
	String path = "koha/";
	String vm = "";
	...
	private void getStudent() throws Exception {
		...
		if ( student != null ) {
	    	...
	    	String pwd = "EIUKLEB8";
	    	String password = "RB3D5EAVqfdZsM/bErv77g";
			KohaAccount acct = KohaHelper.getInstance().createAccount(student, pwd, password);
