...
FCKConfig.ToolbarSets["Default_Bak"] = [
	['Save','Source','DocProps','-', 'Preview','-','Templates'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print','SpellCheck'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	'/',
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
...
FCKConfig.ToolbarSets["Simple"] = [
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','-','OrderedList','UnorderedList', 'Outdent','Indent','-','Image', 'Link','Unlink','-'],
	'/',
	['FontFormat','FontName','FontSize']
] ;

FCKConfig.ToolbarSets["Editor_Basic"] = [
...
FCKConfig.FlashUpload = false ; //SBAHRIN SET TO FALSE
