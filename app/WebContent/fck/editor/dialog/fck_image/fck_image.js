...
{
	window.open('../../../x/lebah.util.ImagesBrowseModule','images','width=600,height=400,toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,copyhistory=yes,resizable=yes');
