...
public class StudentProgramTypeModule  extends AjaxModule {
	
	String path = "apps/util/graduation_type/";
	...
	private void listStudents() {
		...
		sql = "select s from Student s where (s.fakeStudent is null OR s.fakeStudent = '') and s.program = :program and s.intake = :intake order by s.biodata.name";
