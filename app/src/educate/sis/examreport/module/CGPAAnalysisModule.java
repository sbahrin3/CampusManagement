 ...
 * @version 1.0
 */
public class CGPAAnalysisModule extends AjaxModule {
	
	private DbPersistence db = new DbPersistence();
	private static String path = "apps/examination_reports/cgpa/";
	private String vm = "";
	...
	private void viewReport() {
		...
		ExamResultStatistic stat = new ExamResultStatistic();
		List<GradeResult> gradeResults = stat.getCGPASummary(intakeId, periodId, facultyId);
